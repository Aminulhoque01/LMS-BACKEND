...
exports.lessonController = exports.completeLesson = exports.getCourseLessons = exports.create = void 0;
...
const getCourseLessons = async (req, res) => {
    const lessons = await service.getCourseLessons(req.params.courseId);
    res.json(lessons);
};
exports.getCourseLessons = getCourseLessons;
const completeLesson = async (req, res) => {
    const result = await service.markLessonComplete(req.body.lessonId, req.body.enrollmentId);
    res.json(result);
};
